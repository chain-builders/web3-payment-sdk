...
const Hero = () => {
  return (
    <div className="h-[95vh] w-[full] bg-black rounded-2xl px-12 py-6 relative overflow-hidden">
      <Nav />
      ...
      <div className="w-full mt-32 flex items-center justify-center ">
        ...
        <div className="flex flex-col items-center text-center space-y-6">
          <h1 className="text-6xl font-clash-display font-bold text-white max-w-4xl leading-tight tracking-wide">
            The Next Generation Web3 Payment Infrastructure
          </h1>
      ...
      <img
        src="/heroimg.png"
        alt=""
        className="objec-cover h-[200px] absolute -bottom-14 -right-22"
      />
    </div>
  );
};
